...
import 'package:swap/widgets/describ_widget.dart';
import 'package:swap/widgets/tricket_subject_widget.dart';

class TricketSubjectScreen extends StatelessWidget {
  @override
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              TricketSubjectWidget(),
              DescribWidget(),
              Container(
                margin: EdgeInsets.fromLTRB(
                    0 * fem, 0 * fem, 83.39 * fem, 263 * fem),
                width: 257 * fem,
                decoration: BoxDecoration(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.pushNamed(context, '/attachPhotoScreen');
                      },
                      style: TextButton.styleFrom(
                        padding: EdgeInsets.zero,
                      ),
