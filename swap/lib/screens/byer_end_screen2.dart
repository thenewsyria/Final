...
class ByerEndScreen2 extends StatelessWidget {
  @override
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: AssetImage(
                                              'assets/main-ui/images/ellipse-187-bg-oPs.png',
                                            ),
                                          ),
                                        ),
                                        child: Align(
                                          ...
                                          child: SizedBox(
                                            ...
                                            height: 12 * fem,
                                            child: Image.asset(
                                              'assets/main-ui/images/icon-wqF.png',
                                              width: 12 * fem,
                                              height: 12 * fem,
                                            ),
                                          ),
              ...
              Container(
                // group9302818aUM (205:2177)
                padding:
                    EdgeInsets.fromLTRB(20 * fem, 20 * fem, 20 * fem, 16 * fem),
                width: double.infinity,
                height: 76 * fem,
                child: Container(
                  // group93028176Sh (205:2179)
                  padding:
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 21.5 * fem,
                        child: Image.asset(
                          'assets/main-ui/images/plus-pzy.png',
                          width: 21.5 * fem,
                          height: 21.5 * fem,
                        ),
                      ),
                      Container(
                        // group9302816tdT (205:2192)
                        margin: EdgeInsets.fromLTRB(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              // iconemojiqh7 (205:2195)
                              width: 22 * fem,
                              height: 22 * fem,
                              child: Image.asset(
                                'assets/main-ui/images/icon-emoji-nF7.png',
                                width: 22 * fem,
                                height: 22 * fem,
                              ),
                            ),
                      ...
                      Container(
                        ...
                        height: 17.82 * fem,
                        child: Image.asset(
                          'assets/main-ui/images/camera-V5X.png',
                          width: 20 * fem,
                          height: 17.82 * fem,
                        ),
                      ),
                      Container(
                        ...
                        height: 21.5 * fem,
                        child: Image.asset(
                          'assets/main-ui/images/voice-ZHP.png',
                          width: 17.5 * fem,
                          height: 21.5 * fem,
                        ),
                      ),
