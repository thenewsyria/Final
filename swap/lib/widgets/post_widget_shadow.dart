...
class PostWidgetShadow extends StatelessWidget {
  const PostWidgetShadow({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.fromLTRB(8 * fem, 11.5 * fem, 8 * fem, 12 * fem),
      ...
      child: Row(
        ...
        children: [
          Container(
            margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 10 * fem, 4.5 * fem),
            width: 114 * fem,
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      'assets/main-ui/images/rectangle-2933-MeD.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: AssetImage(
                              'assets/main-ui/images/ellipse-173-bg-32V.png',
                            ),
                          ),
                        ),
                      ),
